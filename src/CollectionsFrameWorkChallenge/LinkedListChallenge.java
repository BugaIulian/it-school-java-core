...
public class LinkedListChallenge {
    ...
    public static void main(String[] args) {
        ...
        printLinkedListValues(firstNumberList);
        printFromASpecificIndexOfLinkedList(firstNumberList, 2);
        printLinkedListInReverseOrder(firstNumberList);
        ...
        printFirstAndLastOccurrenceOfSpecifiedElement(secondNumberList);
        printElementsAndPositionInLinkedList(secondNumberList);
    ...
    private static void printElementsAndPositionInLinkedList(LinkedList<Integer> someNumbers) {
    ...
    private static void printFirstAndLastOccurrenceOfSpecifiedElement(LinkedList<Integer> someNumbers) {
    ...
    private static void printLinkedListInReverseOrder(LinkedList<Integer> linkedList) {
        Collections.reverse(linkedList);
        linkedList.forEach(numbers -> System.out.println(numbers));
    }

    private static void printFromASpecificIndexOfLinkedList(LinkedList<Integer> linkedList, int index) {
    ...
    private static void printLinkedListValues(LinkedList<Integer> linkedList) {
